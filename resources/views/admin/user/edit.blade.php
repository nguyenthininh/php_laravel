...
@section("top_content")
    <div class="col-md-12">
        <div class="overview-wrap">
            <h2 class="title-1">Sửa danh mục user</h2>
        </div>
    </div>
@endsection
            ...
            <div class="card-body"><h5 class="card-title">Thêm danh mục</h5>
                <form action="{{url("admin/user/update",['id'=>$user->id])}}" method="post">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input style="margin-bottom: 20px;" name="role" type="number" id="role" placeholder="role"
                               value="{{old("role")}}" class="form-control @if($errors->has("role"))is-invalid @endif ">
